...
create table if not exists public.hammerex_canteen_saved_posts (
...
create unique index if not exists hammerex_canteen_saved_posts_unique
  on public.hammerex_canteen_saved_posts (post_id, saver_slug);
...
create index if not exists hammerex_canteen_saved_posts_canteen_post
  on public.hammerex_canteen_saved_posts (canteen_id, post_id);
...
create index if not exists hammerex_canteen_saved_posts_saver
  on public.hammerex_canteen_saved_posts (saver_slug, canteen_id);
