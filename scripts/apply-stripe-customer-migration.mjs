// One-shot: apply the Stripe customer/subscription column migration to
// the live hammerex Supabase project, then exit. Idempotent — uses
...
const sql = readFileSync(
  "C:\\Users\\Victus\\trades\\supabase\\migrations\\20260628100000_xrated_stripe_customer.sql",
  "utf-8"
);
