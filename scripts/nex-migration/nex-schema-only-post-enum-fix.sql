...
\restrict jUuVudHRaP0w4hGNYazFUMxcDVmhjab9aoBxfjxIRv51TfHmpBWKzo8hDItzPvA
...
--
-- Name: nex_food_claim_status; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_enrichment_agent; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_enrichment_status; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_event_type; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_field_trust; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_next_action; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_outreach_channel; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_outreach_status; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_owner_status; Type: TYPE; Schema: nex; Owner: -
--
...
--
-- Name: nex_food_source_type; Type: TYPE; Schema: nex; Owner: -
--
...
CREATE TABLE nex.food_business (
    ...
    source_licence_terms text,
    dedupe_hash text NOT NULL,
    claim_status nex.nex_food_claim_status DEFAULT 'discovered'::nex.nex_food_claim_status NOT NULL,
    owner_status nex.nex_food_owner_status DEFAULT 'unknown'::nex.nex_food_owner_status NOT NULL,
    hero_image_url text,
    hero_image_source text,
    hero_image_approved boolean DEFAULT false NOT NULL,
    hero_image_provenance jsonb,
...
CREATE TABLE nex.food_enrichment_evidence (
    ...
    value_normalised text,
    source text NOT NULL,
    source_type nex.nex_food_source_type NOT NULL,
    source_url text,
    confidence numeric(3,2) NOT NULL,
    agent_name nex.nex_food_enrichment_agent NOT NULL,
    discovered_at timestamp with time zone DEFAULT now() NOT NULL,
    provenance_layer nex.nex_food_field_trust DEFAULT 'source_import'::nex.nex_food_field_trust NOT NULL,
    raw_snippet text,
    raw_payload jsonb,
...
CREATE TABLE nex.food_business_field_provenance (
    business_ref text NOT NULL,
    field_name text NOT NULL,
    trust_layer nex.nex_food_field_trust NOT NULL,
    written_at timestamp with time zone DEFAULT now() NOT NULL,
    written_by text,
    source_reference text,
    cycle_run_id uuid
...
CREATE TABLE nex.food_business_next_action (
    business_ref text NOT NULL,
    next_action nex.nex_food_next_action NOT NULL,
    reason text NOT NULL,
    computed_at timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE nex.food_commercial_event (
    event_id uuid DEFAULT gen_random_uuid() NOT NULL,
    business_ref text NOT NULL,
    event_type nex.nex_food_event_type NOT NULL,
...
CREATE MATERIALIZED VIEW nex.food_business_value AS
 SELECT b.public_listing_ref AS business_ref,
    ...
    (COALESCE(sum(
        CASE
            WHEN (e.event_type = 'profile_view'::nex.nex_food_event_type) THEN 1
            ELSE 0
        END), (0)::bigint))::integer AS profile_views,
    (COALESCE(sum(
        CASE
            WHEN (e.event_type = 'search_appearance'::nex.nex_food_event_type) THEN 1
            ELSE 0
        END), (0)::bigint))::integer AS search_appearances,
    (COALESCE(sum(
        CASE
            WHEN (e.event_type = 'enquiry'::nex.nex_food_event_type) THEN 1
            ELSE 0
        END), (0)::bigint))::integer AS enquiries,
    (COALESCE(sum(
        CASE
            WHEN (e.event_type = 'qualified_enquiry'::nex.nex_food_event_type) THEN 1
            ELSE 0
        END), (0)::bigint))::integer AS qualified_enquiries,
    (COALESCE(sum(
        CASE
            WHEN (e.event_type = 'booking_request'::nex.nex_food_event_type) THEN 1
            ELSE 0
        END), (0)::bigint))::integer AS booking_requests,
    (COALESCE(sum(
        CASE
            WHEN (e.event_type = 'price_request'::nex.nex_food_event_type) THEN 1
            ELSE 0
        END), (0)::bigint))::integer AS price_requests,
    (COALESCE(sum(
        CASE
            WHEN (e.event_type = 'payment'::nex.nex_food_event_type) THEN e.event_value_idr
            ELSE (0)::numeric
        END), (0)::numeric))::numeric(14,2) AS revenue_idr,
    max(e.created_at) FILTER (WHERE (e.event_type = ANY (ARRAY['enquiry'::nex.nex_food_event_type, 'qualified_enquiry'::nex.nex_food_event_type, 'booking_request'::nex.nex_food_event_type, 'price_request'::nex.nex_food_event_type]))) AS last_customer_activity_at,
    (((((((COALESCE(sum(
        CASE
            WHEN (e.event_type = 'profile_view'::nex.nex_food_event_type) THEN 1
            ELSE 0
...
CREATE TABLE nex.food_enrichment_job (
    job_id uuid DEFAULT gen_random_uuid() NOT NULL,
    business_ref text NOT NULL,
    agent nex.nex_food_enrichment_agent NOT NULL,
    status nex.nex_food_enrichment_status DEFAULT 'pending'::nex.nex_food_enrichment_status NOT NULL,
    attempts integer DEFAULT 0 NOT NULL,
...
CREATE TABLE nex.food_outreach_suppression (
    ...
    business_ref text NOT NULL,
    channel nex.nex_food_outreach_channel,
    reason text NOT NULL,
...
CREATE VIEW nex.food_commercial_universe AS
 SELECT public_listing_ref,
    ...
    (EXISTS ( SELECT 1
          ...
          WHERE ((j.business_ref = b.public_listing_ref) AND (j.status = 'needs_review'::nex.nex_food_enrichment_status)))) AS ambiguous_identity_pending
   FROM nex.food_business b
  WHERE ((claim_status = ANY (ARRAY['listed'::nex.nex_food_claim_status, 'invited'::nex.nex_food_claim_status, 'claimed'::nex.nex_food_claim_status, 'paying'::nex.nex_food_claim_status])) AND (((whatsapp_number IS NOT NULL) AND (whatsapp_number <> ''::text)) OR ((phone IS NOT NULL) AND (phone <> ''::text))) AND (NOT (EXISTS ( SELECT 1
...
CREATE TABLE nex.food_next_action_audit (
    ...
    business_ref text NOT NULL,
    from_action nex.nex_food_next_action,
    to_action nex.nex_food_next_action NOT NULL,
    reason text NOT NULL,
    input_snapshot jsonb NOT NULL,
    computed_at timestamp with time zone DEFAULT now() NOT NULL,
    computed_by text
...
CREATE TABLE nex.food_outreach_attempt (
    attempt_id uuid DEFAULT gen_random_uuid() NOT NULL,
    business_ref text NOT NULL,
    channel nex.nex_food_outreach_channel NOT NULL,
    template_id text NOT NULL,
    status nex.nex_food_outreach_status NOT NULL,
    status_reason text,
    destination text NOT NULL,
...
CREATE VIEW nex.food_reverification_candidates AS
 SELECT b.public_listing_ref,
  ...
  WHERE ((b.claim_status = ANY (ARRAY['listed'::nex.nex_food_claim_status, 'invited'::nex.nex_food_claim_status, 'claimed'::nex.nex_food_claim_status, 'paying'::nex.nex_food_claim_status, 'discovered'::nex.nex_food_claim_status])) AND ((f.freshness_status = ANY (ARRAY['AGING'::text, 'STALE'::text, 'EXPIRED'::text])) OR ((f.freshness_status = 'UNVERIFIED'::text) AND (b.claim_status = 'listed'::nex.nex_food_claim_status))))
  ORDER BY
...
CREATE VIEW nex.food_universe_ratio AS
 SELECT ( SELECT (count(*))::integer AS count
          ...
          WHERE (food_business.claim_status = ANY (ARRAY['discovered'::nex.nex_food_claim_status, 'verifying'::nex.nex_food_claim_status, 'listed'::nex.nex_food_claim_status, 'invited'::nex.nex_food_claim_status, 'claimed'::nex.nex_food_claim_status, 'paying'::nex.nex_food_claim_status]))) AS discovery_universe,
    ...
    ((( SELECT (count(*))::integer AS count
           ...
           FROM nex.food_business
          WHERE (food_business.claim_status = ANY (ARRAY['listed'::nex.nex_food_claim_status, 'invited'::nex.nex_food_claim_status, 'claimed'::nex.nex_food_claim_status, 'paying'::nex.nex_food_claim_status]))), 0))::numeric) AS commercial_ratio,
    now() AS computed_at;
...
CREATE INDEX idx_food_job_status_next ON nex.food_enrichment_job USING btree (status, next_attempt_at) WHERE (status = ANY (ARRAY['pending'::nex.nex_food_enrichment_status, 'failed'::nex.nex_food_enrichment_status]));
...
CREATE UNIQUE INDEX uniq_food_job_active_per_business_agent ON nex.food_enrichment_job USING btree (business_ref, agent) WHERE (status = ANY (ARRAY['pending'::nex.nex_food_enrichment_status, 'running'::nex.nex_food_enrichment_status]));
...
\unrestrict jUuVudHRaP0w4hGNYazFUMxcDVmhjab9aoBxfjxIRv51TfHmpBWKzo8hDItzPvA
