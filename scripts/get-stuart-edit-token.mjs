// One-off: retrieve Stuart's edit_token + verify merchant-grade gate
// for the report URL the user will visit.
...
const stuart = await q(`
  SELECT slug, edit_token, primary_trade, display_name, addons_enabled
