...
import type { CalculatorOutput, GravelScenario } from "../logic";
...
function buildMessage(
  ...
  const lines = [
    `Hi — I've priced up an aggregate order using your calculator:`,
    ``,
    ...
    ``,
    `Can you confirm stock + delivery lead time?`
  ];
