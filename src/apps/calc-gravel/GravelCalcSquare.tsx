...
export type GravelCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function GravelCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: GravelCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Package}>Aggregate calc</Overline>
