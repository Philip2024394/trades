...
import { Boxes, LayoutGrid, Wrench } from "lucide-react";
import type { ComponentType } from "react";
import { Select } from "@/platform/ui";
import type { MortarScenario } from "../logic";
...
> = {
  brickwork: Boxes,
  blockwork: LayoutGrid,
  repointing: Wrench
};

const ORDER: readonly MortarScenario[] = [
  "brickwork",
  "blockwork",
  "repointing"
];
...
export type ScenarioPickerProps = {
  ...
  labels: Record<MortarScenario, string>;
  onChange: (s: MortarScenario) => void;
  ...
  if (mode === "select") {
    return (
      <Select
        id="mortar-scenario"
        value={scenario}
        onChange={(e) => onChange(e.currentTarget.value as MortarScenario)}
