...
export type MortarCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function MortarCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: MortarCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Container}>Mortar calc</Overline>
