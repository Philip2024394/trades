...
export type BricksCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function BricksCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: BricksCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Boxes}>Bricks calc</Overline>
