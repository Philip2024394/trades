...
import type { BricksScenario, CalculatorOutput } from "../logic";
...
function buildMessage(
  ...
  const lines = [
    `Hi — I've priced up a brickwork job using your calculator:`,
    ``,
    ...
    ``,
    `Can you confirm stock + bricklayer availability?`
  ];
