// ShoppingList — render-install complementary subcategories.

import { CornerDownRight, Droplet, Grid2x2, ShieldCheck, Wrench } from "lucide-react";
import type { ComponentType } from "react";

type Meta = { label: string; icon: ComponentType<{ className?: string }> };

const META: Record<string, Meta> = {
  render_mesh: { label: "Fibreglass reinforcement mesh", icon: Grid2x2 },
  scrim_corner: { label: "Corner bead + scrim", icon: CornerDownRight },
  primer: { label: "Bonding primer", icon: Droplet },
  scraper: { label: "Rendering scraper / trowel", icon: Wrench }
};
