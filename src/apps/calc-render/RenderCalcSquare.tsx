...
export type RenderCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function RenderCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: RenderCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Brush}>Render calc</Overline>
