...
import type { CalculatorOutput, PlasterboardScenario } from "../logic";
...
function buildMessage(
  ...
  const lines = [
    `Hi — I've priced up a plasterboard job using your calculator:`,
    ``,
    ...
    ``,
    `Can you confirm stock + plasterer availability?`
  ];
