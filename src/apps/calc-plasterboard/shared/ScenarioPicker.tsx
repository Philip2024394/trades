...
import { Home, LayoutGrid, MoveDown } from "lucide-react";
import type { ComponentType } from "react";
import { Select } from "@/platform/ui";
import type { PlasterboardScenario } from "../logic";
...
const ORDER: readonly PlasterboardScenario[] = [
  "walls",
  "ceilings",
  "whole_room"
];
...
export type ScenarioPickerProps = {
  ...
  labels: Record<PlasterboardScenario, string>;
  onChange: (s: PlasterboardScenario) => void;
...
export function ScenarioPicker({
  ...
  if (mode === "select") {
    return (
      <Select
        id="plasterboard-scenario"
        value={scenario}
        onChange={(e) =>
          onChange(e.currentTarget.value as PlasterboardScenario)
        }
