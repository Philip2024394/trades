// PlasterboardCalcSquare — 1:1 aspect.
...
export type PlasterboardCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function PlasterboardCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: PlasterboardCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={LayoutGrid}>Plasterboard calc</Overline>
