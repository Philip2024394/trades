// PlasterboardCalcLandscape — 4:3 / 16:9 wide layout.
...
export type PlasterboardCalcLandscapeProps = {
...
export function PlasterboardCalcLandscape({
  product,
  whatsappNumber,
  onAddToCart,
  onShare,
  hideAddToCart
}: PlasterboardCalcLandscapeProps) {
  const calc = usePlasterboardCalc({ product });
  return (
    <SurfaceCard variant="primary" padding="lg" className="w-full">
      <div className="mb-4">
        <SectionHeader
          overline="Plasterboard calculator"
          overlineIcon={LayoutGrid}
          title="Estimate sheets, screws, scrim, and filler"
          subtitle="3 UK scenarios · 1200×2400 (2.88 m²) and 1200×1800 (2.16 m²) sheets · MR / green board for wet rooms"
        />
      </div>
