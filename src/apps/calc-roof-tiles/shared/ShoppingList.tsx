// ShoppingList — roofing complementary subcategories.
...
const META: Record<string, Meta> = {
  ridge_tile: { label: "Ridge tiles (300 mm gauge)", icon: Anchor },
  eaves_felt: { label: "Eaves membrane / drip edge", icon: Layers },
  roofing_batten: { label: "Roofing battens (25×50 treated)", icon: Layers },
  roofing_nail: { label: "Tile / slate nails", icon: Zap }
};
