// ShoppingList — fencing-install complementary subcategories.
...
const META: Record<string, Meta> = {
  postcrete: { label: "Postcrete (1 bag per post)", icon: Package },
  post_cap: { label: "Post caps", icon: Square },
  gravel_board: { label: "Gravel boards", icon: BarChart3 },
  gate_hinge: { label: "Gate hinge + latch kit", icon: Grip },
  fence_paint: { label: "Fence paint / preservative", icon: Droplet }
};
