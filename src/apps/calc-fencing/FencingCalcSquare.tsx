...
export type FencingCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function FencingCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: FencingCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Fence}>Fencing calc</Overline>
