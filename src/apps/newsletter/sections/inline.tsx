...
// App section: newsletter / inline.
// Registers `app.newsletter.inline`.
...
type NewsletterData = { enabled: true };
...
function NewsletterInner({
  ...
  return (
    <section
      ...
      data-app-section="newsletter.inline"
    >
      <div
        style={{
...
defineAppSection<NewsletterConfig, NewsletterData>({
  manifest: newsletterManifest,
  localId: "inline",
  name: "Newsletter Signup",
  library: "newsletter",
  description:
    "Inline email capture form — appearance only, compliance is baked in.",
  thumbnail: "/studio/thumbnails/newsletter-inline.png",
