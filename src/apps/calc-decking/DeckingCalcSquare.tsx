...
export type DeckingCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function DeckingCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: DeckingCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Rows3}>Decking calc</Overline>
