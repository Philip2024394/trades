...
import type { CalculatorOutput, DeckingScenario } from "../logic";
...
function buildMessage(result: CalculatorOutput, scenarioLabel: string): string {
  ...
  const lines = [
    `Hi — I've priced up a decking job using your calculator:`,
    ``,
    ...
    ``,
    `Can you confirm stock + carpenter availability?`
  ];
