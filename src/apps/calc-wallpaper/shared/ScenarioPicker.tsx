// ScenarioPicker — 3-scenario chooser (feature wall / whole room / stairwell).

"use client";

import { Home, Square, TrendingUp } from "lucide-react";
import type { ComponentType } from "react";
import { Select } from "@/platform/ui";
import type { WallpaperScenario } from "../logic";
...
const ORDER: readonly WallpaperScenario[] = [
  "feature_wall",
  "whole_room",
  "stairwell"
];
...
export type ScenarioPickerProps = {
  ...
  labels: Record<WallpaperScenario, string>;
  onChange: (s: WallpaperScenario) => void;
...
export function ScenarioPicker({
  ...
  if (mode === "select") {
    return (
      <Select
        id="wallpaper-scenario"
        value={scenario}
        onChange={(e) => onChange(e.currentTarget.value as WallpaperScenario)}
