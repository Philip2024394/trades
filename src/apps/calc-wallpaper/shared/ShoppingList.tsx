// ShoppingList — wallpaper-hang complementary subcategories.
...
const META: Record<string, Meta> = {
  wallpaper_paste: { label: "Wallpaper paste", icon: Droplet },
  wallpaper_smoother: { label: "Smoother / brush", icon: Layers },
  sandpaper: { label: "Fine sandpaper", icon: Ruler },
  filler: { label: "Wall filler", icon: Wrench },
  scraper: { label: "Scraper / trimming knife", icon: Scissors }
};
