...
import type { CalculatorOutput, WallpaperScenario } from "../logic";
...
function buildMessage(result: CalculatorOutput, scenarioLabel: string): string {
  ...
  const lines = [
    `Hi — I've priced up a wallpapering job using your calculator:`,
    ``,
    ...
    ``,
    `Can you confirm stock + decorator availability?`
  ];
