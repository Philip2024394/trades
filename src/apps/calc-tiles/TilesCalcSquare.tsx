// TilesCalcSquare — 1:1 aspect for grid tiles.
...
export type TilesCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function TilesCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: TilesCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Grid3x3}>Tiles calc</Overline>
