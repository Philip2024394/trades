// ShoppingList — tile-install complementary subcategories.
...
const META: Record<string, Meta> = {
  tile_adhesive: { label: "Tile adhesive", icon: Container },
  grout: { label: "Grout", icon: Droplet },
  tile_spacer: { label: "Spacers", icon: Minus },
  tile_sealant: { label: "Sealant", icon: Droplet },
  tile_trim: { label: "Edge trim / bullnose", icon: Package },
  sub_base: { label: "Sub-base + mortar bed", icon: Layers }
};
