// ResultPanel — tiles result renderer. Same shape as calc-paint /
// calc-flooring for consistency across all calc apps.
      ...
      {primary ? (
        <div className="flex items-baseline justify-between border-b border-neutral-200 pb-2">
          ...
          <div className="text-right">
            ...
            {primary.detail ? (
              <div className="text-[11px] text-neutral-500">{primary.detail}</div>
            ) : null}
          </div>
        </div>
      ) : null}
