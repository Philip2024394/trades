// ShoppingList — complementary subcategories for flooring installs.
...
const META: Record<string, Meta> = {
  underlay: { label: "Underlay", icon: Layers },
  beading: { label: "Beading / scotia", icon: Package },
  threshold_bar: { label: "Threshold bars", icon: Package },
  floor_adhesive: { label: "Floor adhesive", icon: Droplet },
  drywall_screw: { label: "Stair-nose fixings", icon: Wrench }
};
