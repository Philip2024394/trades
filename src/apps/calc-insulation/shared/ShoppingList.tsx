// ShoppingList — insulation-install complementary subcategories.
...
const META: Record<string, Meta> = {
  vapour_barrier: { label: "Vapour barrier / VCL", icon: Waves },
  insulation_tape: { label: "Insulation tape", icon: Tag },
  drywall_screw: { label: "Drywall screws", icon: BadgeCheck },
  breather_membrane: { label: "Breather membrane", icon: Wind },
  edge_strip: { label: "Perimeter foam strip", icon: Sparkles }
};
