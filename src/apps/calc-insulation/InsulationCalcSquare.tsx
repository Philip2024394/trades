// InsulationCalcSquare — 1:1 aspect.
...
export type InsulationCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function InsulationCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: InsulationCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Snowflake}>Insulation calc</Overline>
