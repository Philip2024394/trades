...
export type PavingCalcSquareProps = {
  product?: CalculatorProductRef;
  whatsappNumber?: string;
  hideShoppingList?: boolean;
};

export function PavingCalcSquare({
  product,
  whatsappNumber,
  hideShoppingList
}: PavingCalcSquareProps) {
  ...
  return (
    ...
    >
      <div className="mb-2">
        <Overline icon={Grid3x3}>Paving calc</Overline>
