...
import type { CalculatorOutput, TurfScenario } from "../logic";
...
function buildMessage(result: CalculatorOutput, scenarioLabel: string): string {
  ...
  const lines = [
    `Hi — I've priced up a turf job using your calculator:`,
    ``,
    ...
    ``,
    `Can you confirm turf delivery date + gardener availability?`
  ];
