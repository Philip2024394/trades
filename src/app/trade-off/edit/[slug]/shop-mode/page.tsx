// thenetworkers.app Trade Off — Shop Mode editor.
...
export const metadata: Metadata = {
  title: "Trade Center editor | thenetworkers.app",
...
function InvalidLink({ reason }: { reason: string }) {
  ...
  const msg = encodeURIComponent(
    "Hi thenetworkers.app — I'm trying to edit my Trade Center but my link isn't working. Can you help?"
  );
  return (
    <main className="min-h-screen bg-brand-bg text-brand-text">
      <DashboardHeader />
