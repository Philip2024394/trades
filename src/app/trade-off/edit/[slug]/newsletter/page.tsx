// xratedtrade.com Trade Off — Newsletter subscribers editor.
//
...
export const metadata: Metadata = {
  title: "Newsletter subscribers | xratedtrade.com",
...
function InvalidLink({ reason }: { reason: string }) {
  ...
  const msg = encodeURIComponent(
    "Hi xratedtrade.com — I'm trying to manage my newsletter subscribers but my link isn't working. Can you help?"
  );
  return (
    <main className="min-h-screen bg-brand-bg text-brand-text">
      <DashboardHeader />
