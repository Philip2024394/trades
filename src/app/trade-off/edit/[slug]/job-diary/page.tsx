// thenetworkers.app Trade Off — Job Diary editor.
...
export const metadata: Metadata = {
  title: "Job Diary editor | thenetworkers.app",
...
function InvalidLink({ reason }: { reason: string }) {
  ...
  const msg = encodeURIComponent(
    "Hi thenetworkers.app — I'm trying to edit my Job Diary but my link isn't working. Can you help?"
  );
  return (
    <main className="min-h-screen bg-brand-bg text-brand-text">
      <DashboardHeader />
