// thenetworkers.app Trade Off — Materials Network editor.
//
...
export const metadata: Metadata = {
  title: "Materials Network editor | thenetworkers.app",
...
function InvalidLink({ reason }: { reason: string }) {
  ...
  const msg = encodeURIComponent(
    "Hi thenetworkers.app — I'm trying to edit my Materials Network but my link isn't working. Can you help?"
  );
  return (
    <main className="min-h-screen bg-brand-bg text-brand-text">
      <DashboardHeader />
