// /hostel · Task #89 Phase B (2026-08-22) · focused hostel route.
...
export const metadata = { title: "NEX Hostel · Yogyakarta" };
...
export default async function HostelPage({ searchParams }: { searchParams?: Promise<{ country?: string }> }) {
  ...
  return (
    <NexDirectoryFeed
      categoryId={CAT_ID}
      categoryLabel={meta?.displayName.en ?? "Hostel"}
      categoryIcon={meta?.icon ?? "🛏️"}
      city="Yogyakarta"
