// NEX Worker Journal — /nex-head-quarters/journal
//
      ...
      <div className="mx-auto max-w-[1120px] px-5 pb-24 pt-8 md:px-8 md:pt-10">
        ...
        {(jobFilter || workerFilter || eventFilter || providerFilter) && (
          <div className="mt-4 flex flex-wrap items-center gap-2">
            ...
            <Link
              href="/nex-head-quarters/journal"
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          ...
          {[
            ...
            <Link
              key={h}
              href={`/nex-head-quarters/journal?${buildQuery({ hoursFilter: h, jobFilter, workerFilter, eventFilter, providerFilter })}`}
        ...
        return (
          ...
          >
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1">
              ...
              {e.job_id && !focusJob ? (
                <Link
                  href={`/nex-head-quarters/journal?job=${e.job_id}`}
