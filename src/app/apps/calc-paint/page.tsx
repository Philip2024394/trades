// Preview page for the Paint Calculator app — renders all 3 sizes so
// designers + tradespeople can see the layout options at a glance.

import type { Metadata } from "next";
import { PaintCalcApp, CALC_PAINT_APP_MANIFEST } from "@/apps/calc-paint";

export const metadata: Metadata = {
  title: "Paint Calculator — App preview",
  description: "Landscape / square / portrait embed sizes for calc-paint.",
  robots: { index: false, follow: false }
};

export default function PaintCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <PaintCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <PaintCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
