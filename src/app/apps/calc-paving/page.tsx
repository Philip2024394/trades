// Preview page for the Paving Calculator app.

import type { Metadata } from "next";
import {
  CALC_PAVING_APP_MANIFEST,
  PavingCalcApp
} from "@/apps/calc-paving";

export const metadata: Metadata = {
  title: "Paving Calculator — App preview",
  description: "Landscape / square / portrait embed sizes for calc-paving.",
  robots: { index: false, follow: false }
};

export default function PavingCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <PavingCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <PavingCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="max-w-sm">
              <PavingCalcApp size="portrait" whatsappNumber="+353000000000" />
            </div>
          </div>
        </section>
      </div>
