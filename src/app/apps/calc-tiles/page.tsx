// Preview page for the Tiles Calculator app — 3 size sections.

import type { Metadata } from "next";
import {
  CALC_TILES_APP_MANIFEST,
  TilesCalcApp
} from "@/apps/calc-tiles";

export const metadata: Metadata = {
  title: "Tiles Calculator — App preview",
  description: "Landscape / square / portrait embed sizes for calc-tiles.",
  robots: { index: false, follow: false }
};

export default function TilesCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <TilesCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <TilesCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="max-w-sm">
              <TilesCalcApp size="portrait" whatsappNumber="+353000000000" />
            </div>
          </div>
        </section>
      </div>
