// Preview page for the Flooring Calculator app — 3 size sections.

import type { Metadata } from "next";
import {
  CALC_FLOORING_APP_MANIFEST,
  FlooringCalcApp
} from "@/apps/calc-flooring";

export const metadata: Metadata = {
  title: "Flooring Calculator — App preview",
  description: "Landscape / square / portrait embed sizes for calc-flooring.",
  robots: { index: false, follow: false }
};

export default function FlooringCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <FlooringCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <FlooringCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
