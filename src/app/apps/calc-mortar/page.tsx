// Preview page for the Mortar Calculator app.

import type { Metadata } from "next";
import {
  CALC_MORTAR_APP_MANIFEST,
  MortarCalcApp
} from "@/apps/calc-mortar";

export const metadata: Metadata = {
  title: "Mortar Calculator — App preview",
  description: "Landscape / square / portrait embed sizes for calc-mortar.",
  robots: { index: false, follow: false }
};

export default function MortarCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <MortarCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <MortarCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="max-w-sm">
              <MortarCalcApp size="portrait" whatsappNumber="+353000000000" />
            </div>
          </div>
        </section>
      </div>
