// Preview page for the Turf & Topsoil Calculator app.

import type { Metadata } from "next";
import {
  CALC_TURF_APP_MANIFEST,
  TurfCalcApp
} from "@/apps/calc-turf";

export const metadata: Metadata = {
  title: "Turf & Topsoil Calculator — App preview",
  description: "Landscape / square / portrait embed sizes for calc-turf.",
  robots: { index: false, follow: false }
};

export default function TurfCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <TurfCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <TurfCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="max-w-sm">
              <TurfCalcApp size="portrait" whatsappNumber="+353000000000" />
            </div>
          </div>
        </section>
      </div>
