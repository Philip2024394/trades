// Preview page for the Plasterboard Calculator app.

import type { Metadata } from "next";
import {
  CALC_PLASTERBOARD_APP_MANIFEST,
  PlasterboardCalcApp
} from "@/apps/calc-plasterboard";

export const metadata: Metadata = {
  title: "Plasterboard Calculator — App preview",
  description:
    "Landscape / square / portrait embed sizes for calc-plasterboard.",
  robots: { index: false, follow: false }
};

export default function PlasterboardCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      <header className="border-b border-neutral-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-6">
          ...
          <h1 className="mt-2 text-2xl font-bold text-neutral-900 md:text-3xl">
            {CALC_PLASTERBOARD_APP_MANIFEST.name}
          </h1>
          <p className="mt-1 max-w-2xl text-[14px] text-neutral-700 md:text-[15px]">
            {CALC_PLASTERBOARD_APP_MANIFEST.description}
          </p>
          <div className="mt-3 flex flex-wrap gap-1.5 text-[11px]">
            <span className="text-neutral-500">Enabled for:</span>
            {CALC_PLASTERBOARD_APP_MANIFEST.tradeAllowlist.map((t) => (
              <span
                key={t}
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <PlasterboardCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <PlasterboardCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
