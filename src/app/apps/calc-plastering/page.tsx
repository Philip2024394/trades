// Preview page for the Plastering Calculator app.

import type { Metadata } from "next";
import {
  CALC_PLASTERING_APP_MANIFEST,
  PlasteringCalcApp
} from "@/apps/calc-plastering";

export const metadata: Metadata = {
  title: "Plastering Calculator — App preview",
  description:
    "Landscape / square / portrait embed sizes for calc-plastering.",
  robots: { index: false, follow: false }
};

export default function PlasteringCalcPreviewPage() {
  return (
        ...
        <section className="mb-10">
          <div className="mb-3">
            ...
            <h2 className="text-[17px] font-semibold text-neutral-900">
              For desktop page embeds — full 3-pane layout
            </h2>
          </div>
          <PlasteringCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <PlasteringCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
