// Preview page for the Insulation Calculator app.

import type { Metadata } from "next";
import {
  CALC_INSULATION_APP_MANIFEST,
  InsulationCalcApp
} from "@/apps/calc-insulation";

export const metadata: Metadata = {
  title: "Insulation Calculator — App preview",
  description:
    "Landscape / square / portrait embed sizes for calc-insulation.",
  robots: { index: false, follow: false }
};

export default function InsulationCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <InsulationCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <InsulationCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
