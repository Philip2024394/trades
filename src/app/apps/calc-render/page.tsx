// Preview page for the Render Calculator app.

import type { Metadata } from "next";
import {
  CALC_RENDER_APP_MANIFEST,
  RenderCalcApp
} from "@/apps/calc-render";

export const metadata: Metadata = {
  title: "Render Calculator — App preview",
  description: "Landscape / square / portrait embed sizes for calc-render.",
  robots: { index: false, follow: false }
};

export default function RenderCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <RenderCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <RenderCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="max-w-sm">
              <RenderCalcApp size="portrait" whatsappNumber="+353000000000" />
            </div>
          </div>
        </section>
      </div>
