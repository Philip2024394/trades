// Preview page for the Decking Calculator app.

import type { Metadata } from "next";
import {
  CALC_DECKING_APP_MANIFEST,
  DeckingCalcApp
} from "@/apps/calc-decking";

export const metadata: Metadata = {
  title: "Decking Calculator — App preview",
  description: "Landscape / square / portrait embed sizes for calc-decking.",
  robots: { index: false, follow: false }
};

export default function DeckingCalcPreviewPage() {
  return (
    <main className="min-h-screen bg-neutral-50 pb-16">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8">
        <section className="mb-10">
          ...
          <DeckingCalcApp size="landscape" whatsappNumber="+353000000000" />
        </section>
        <section className="mb-10">
          <div className="mb-3">
            <div className="text-[11px] font-semibold uppercase tracking-wide text-neutral-500">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <DeckingCalcApp size="square" whatsappNumber="+353000000000" />
          </div>
        </section>
        <section className="mb-10">
          <div className="mb-3">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="max-w-sm">
              <DeckingCalcApp size="portrait" whatsappNumber="+353000000000" />
            </div>
          </div>
        </section>
      </div>
