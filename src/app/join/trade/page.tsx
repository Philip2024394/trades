// /join/trade — the tradesperson-facing landing.
//
// Trades = service providers (plumber, sparks, kitchen fitter,
// bricklayer, etc). Free business app, canteen, and URL — same as
// merchants under the hood (viewer_role='trade'), different framing
// on this landing page.
//
// Merchant landing is /join/merchant. Homeowner is /join/homeowner.
// Master 3-way picker is /join.
...
export const metadata = {
  title: "Join Thenetworkers as a trade — free for life",
  description:
