// POST /api/trade-off/shipping-zones/delete
// Magic-link authenticated. Body: { slug, edit_token, zone_id }.
// Hard delete — shipping zones carry no historical state worth preserving.
...
export async function POST(req: NextRequest) {
  ...
  if (del.error) {
    console.error("[trade-off/shipping-zones/delete] delete failed:", del.error);
    return NextResponse.json(
