// POST /api/nex/feedback
//
// Records a thumbs up/down + optional note on a specific Nex
...
import { recordGap } from "@/lib/nex/gaps";
...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  if (signal === -1) {
    recordGap(id).catch((e) => console.error("[nex/feedback] recordGap failed:", e));
  }
