...
export const metadata: Metadata = {
  title: "Terms & Conditions — Thenetworkers",
  description:
    "The Terms & Conditions for Thenetworkers — the platform for construction trades. Service description, account terms, subscription plans, auto-renewing billing, App Warehouse terms, 14-day cooling-off rights and how to cancel.",
  ...
  openGraph: {
    ...
    title: "Terms & Conditions — Thenetworkers",
    description:
      "Service terms, subscription terms, App Warehouse terms, auto-renewal disclosure, cancellation rights and governing law for Thenetworkers.",
      ...
      >
        <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <p className="mt-3 text-[13px] leading-relaxed text-white/75 sm:text-sm">
            ...
            thenetworkers.app, install Apps from the App Store, or
      ...
      <div className="mx-auto max-w-3xl px-4 pt-8 sm:px-6 sm:pt-10">
        ...
        <article className="mt-8 flex flex-col gap-8 text-[13px] leading-relaxed text-neutral-800 sm:text-sm">
          ...
          <Section n="1" title="Who we are">
            <p>
              thenetworkers.app (operated by Xrated Trades) provides a
              cloud-based business platform at{" "}
              <strong>thenetworkers.app</strong> (the &ldquo;Service&rdquo;).
          ...
          <Section n="4" title="Definitions">
            <ul className="ml-4 flex list-disc flex-col gap-2">
              <li>
                ...
                including the public site at thenetworkers.app, the
              ...
              <li>
                ...
                (e.g. <code>thenetworkers.app/your-name</code>). Your
          ...
          <Section n="17" title="Your Content and our platform">
            ...
            <p>
              ...
              thenetworkers.app, on our related domains, in search
            ...
            <p>
              ...
              property of thenetworkers.app. This applies whether we ship
