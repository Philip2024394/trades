// /<slug>/plant-hire/compliance — full wide-load + nationwide delivery
// + compliance page. Moved off the home so the safety-critical content
// gets its own URL.
...
import { PlantComplianceInfoSection } from "@/components/xrated/profile/PlantHireExtraSections";
...
export async function generateMetadata({
  ...
  return {
    title: `Wide load · Nationwide · Compliance — ${slug}`,
    alternates: { canonical: `/${slug}/plant-hire/compliance` }
  };
}
...
export default async function CompliancePage({
  ...
  if (!cfg.compliance_info.enabled) redirect(`/${slug}/plant-hire`);
