// /<slug>/plant-hire/extend — hire extension / off-hire / early
// collection request. Prefills the hire reference from ?ref.
...
import { PlantHireExtensionForm } from "@/components/xrated/profile/PlantHireExtensionForm";
...
export async function generateMetadata({
  ...
  return {
    title: `Extend / off-hire — ${slug}`,
    alternates: { canonical: `/${slug}/plant-hire/extend` }
  };
}
  ...
  return (
    <main className="flex flex-1 flex-col bg-neutral-50 pb-16">
      ...
      >
        ...
        <span aria-hidden="true">›</span>
        <span className="text-neutral-900">Extend / off-hire</span>
      </nav>
      ...
      <section className="mx-auto w-full max-w-4xl px-4 pt-4 sm:px-6">
        <p className="text-[10px] font-extrabold uppercase tracking-[0.22em] text-[#FFB300]">
          Change · Extension · Off-hire · Early collect
        </p>
        ...
        <p className="mt-2 max-w-2xl text-[14px] leading-relaxed text-neutral-600">
          Extend a running hire, request off-hire collection, or ask to send the machine back
          early. We&rsquo;ll reply on WhatsApp inside 30 minutes.
        </p>
      </section>

      <section className="mx-auto w-full max-w-4xl px-4 pt-6 sm:px-6">
        <PlantHireExtensionForm
