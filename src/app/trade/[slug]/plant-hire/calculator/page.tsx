// /<slug>/plant-hire/calculator — dedicated Site Services Calculator page.
...
import { PlantSiteCalculatorSection } from "@/components/xrated/profile/PlantSiteCalculatorSection";
...
export async function generateMetadata({
  ...
  return {
    title: `Site services calculator — ${slug}`,
    alternates: { canonical: `/${slug}/plant-hire/calculator` }
  };
}
...
export default async function CalculatorPage({
  ...
  if (!cfg.site_calculator.enabled || cfg.site_calculator.materials.length === 0)
  ...
  return (
    <main className="flex flex-1 flex-col bg-neutral-50 pb-16">
      ...
      >
        ...
        <span aria-hidden="true">›</span>
        <span className="text-neutral-900">Site calculator</span>
      </nav>
      ...
      <section className="mx-auto w-full max-w-4xl px-4 pt-4 sm:px-6">
        ...
        <p className="mt-2 max-w-2xl text-[14px] leading-relaxed text-neutral-600">
          {cfg.site_calculator.subheading}
        </p>
      </section>

      <section className="mx-auto w-full max-w-4xl px-4 pt-6 sm:px-6">
        <PlantSiteCalculatorSection
          cfg={cfg.site_calculator}
