// /hotel · Task #89 Phase B (2026-08-22) · focused hotel route.
// Philip: "Hotel is Hotel. Kos is Kos. No: Accommodation → Hotel → results
// for a user who already said Hotel."
...
export const metadata = { title: "NEX Hotel · Yogyakarta" };
...
// Defaults to 'ID'. Invalid params silently fall back to 'ID' (with warning) per Philip's Step 5 decisions.
export default async function HotelPage({ searchParams }: { searchParams?: Promise<{ country?: string }> }) {
  ...
  return (
    <NexDirectoryFeed
      categoryId={CAT_ID}
      categoryLabel={meta?.displayName.en ?? "Hotel"}
