// Shared wizard chrome — progress bar, back link, brand overline.
// Server-safe (no client hooks). Every step wraps its body in this.

import Link from "next/link";
import { ChevronLeft } from "lucide-react";

const STEPS = [
  { key: "start", label: "Project" },
...
export function WizardShell({
  ...
  step: "start" | "details" | "contact" | "matches" | "sent";
  backHref?: string;
  title: string;
  subtitle: string;
...
// Shared field styles — used inside step forms.
