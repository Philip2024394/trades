// /admin/nex/gaps — knowledge gap triage. Highest-flagged first.
// Actions: mark reviewed, promote to KB (stub for now — writes a
// draft entry to the knowledge base), dismiss.
//
// Every thumbs-down on a Nex reply lands here via src/lib/nex/gaps.ts.

import { supabaseAdmin } from "@/lib/supabaseAdmin";
import { GapsTable } from "./GapsTable";

export const dynamic = "force-dynamic";
export const metadata = { title: "Nex gaps — Admin" };
...
export default async function NexGapsPage({
  searchParams
}: {
  ...
  return (
    <div className="mx-auto max-w-6xl p-6">
      <div className="mb-6 flex items-baseline justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black">Nex — Knowledge gaps</h1>
          <p className="mt-1 text-[12px] text-neutral-500">
            Every question Nex answered badly. Highest-signal at the top. Promote to knowledge base to teach me.
          </p>
        </div>
        <a href="/admin/nex" className="text-[12px] font-black text-neutral-500 hover:text-neutral-800">
          ← Back to observatory
        </a>
      </div>
