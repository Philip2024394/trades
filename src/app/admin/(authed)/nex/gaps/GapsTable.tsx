...
export function GapsTable({ rows }: { rows: GapRow[] }) {
  ...
  async function act(id: string, action: "reviewed" | "promoted" | "dismissed", notes?: string) {
    setBusyId(id);
    try {
      const res = await fetch("/api/admin/nex/gaps", {
        method:  "POST",
          ...
          <div key={r.id} className="border-b border-neutral-100 last:border-b-0">
            ...
            {isOpen && (
              <div className="border-t border-neutral-100 bg-neutral-50 p-4">
                ...
                <div className="mb-3">
                  <p className="mb-1 text-[10px] font-black uppercase tracking-wider text-neutral-500">Nex&rsquo;s reply (thumbs-down)</p>
