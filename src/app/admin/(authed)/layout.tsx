...
const NAV_ITEMS: { href: string; label: string; live: boolean; redZone?: boolean }[] = [
  ...
  // 2026-08-22 · Philip: all NEX admin consolidated into NEX Headquarters.
  // Every /admin/nex/* page deleted · everything under /nex-head-quarters.
  { href: "/nex-head-quarters", label: "NEX Headquarters", live: true },
