// shadcn/ui · DropdownMenu — Radix DropdownMenu with theme-aware styling.
...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRight size={16} strokeWidth={2} className="ml-auto opacity-60" aria-hidden="true" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-caption font-extrabold uppercase",
      inset && "pl-8",
      className
    )}
    {...props}
