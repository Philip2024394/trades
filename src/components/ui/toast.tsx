// shadcn/ui · Toast — Radix Toast with theme-aware styling.
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-border bg-transparent px-3 text-body-sm font-bold ring-offset-background transition-colors",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-body-sm font-extrabold", className)}
    {...props}
  />
));
