...
const DEFAULT_BODY =
  "Every product comes with a 1-year workmanship guarantee. Returns accepted within 14 days of delivery — buyer arranges return shipping. If something arrives damaged or faulty, message us on WhatsApp and we'll arrange a replacement or refund — no forms, no waiting.";
