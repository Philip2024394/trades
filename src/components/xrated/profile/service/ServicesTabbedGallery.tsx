...
/**
 * @fileoverview SERVICE-ONLY component.
 * @serviceOnly Only renders for listings whose primary_trade falls in
 * the 'service' template section. Importing from merchant context is
 * a code smell — use the merchant/ siblings instead.
 */
