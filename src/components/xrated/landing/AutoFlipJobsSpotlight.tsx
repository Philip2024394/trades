          ...
          <div className="mt-auto pt-5">
            {job.is_example || !waUrl ? (
              ...
              <a
                ...
                className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#0F7A3F] px-5 text-sm font-bold text-white shadow-lg shadow-[#0F7A3F]/40 transition hover:bg-[#0a5a2d] active:scale-[0.98] sm:w-auto sm:px-7"
              >
