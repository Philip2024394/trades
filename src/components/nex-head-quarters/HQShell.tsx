...
const SECTIONS: SectionDef[] = [
  ...
  // Task #86 (2026-08-22) · Walker live monitor · discovery pipeline verification
  { href: "/nex-head-quarters/walker",                   label: "Walker · Live Monitor",icon: Footprints,  group: "workforce" },
