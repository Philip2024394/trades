...
// Editor — 5-chip Trade Center Picks status picker. Used in the
// add / edit pick modal. Renders as a horizontally-scrollable row on
// mobile so all five chips stay tap-accessible at 375px without
// breaking the layout (mirrors JobDiaryStatusPicker's pattern).
...
export function TradeCenterPicksStatusPicker({
  value,
  onChange
}: {
  value: TradeCenterPickStatusKey | null;
  onChange: (next: TradeCenterPickStatusKey) => void;
}) {
  return (
