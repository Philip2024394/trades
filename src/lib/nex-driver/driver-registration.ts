// src/lib/nex-driver/driver-registration.ts
//
...
//     activation is gated at src/lib/nex-driver/dispatch.ts by NEX_DRIVER_DISPATCH_ENABLED.
//
// Rules enforced:
