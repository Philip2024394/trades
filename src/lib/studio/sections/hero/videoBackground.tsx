...
const registration: SectionRegistration<Config> = {
  ...
  editableFields: [
    { key: "eyebrow", role: "eyebrow",label: "Eyebrow", type: { kind: "text", maxLength: 60 }, default: "Watch the work", priority: "text", aiPromptable: true, group: "Copy" },
    { key: "heading", role: "headline",label: "Headline", type: { kind: "text", maxLength: 100 }, default: "Made to last.", priority: "text", aiPromptable: true, group: "Copy" },
    { key: "subheading", role: "subhead",label: "Subheading", type: { kind: "text", maxLength: 200, multiline: true }, default: "Every job filmed. Every install signed off. Every homeowner gets the same crew, start to finish.", priority: "text", aiPromptable: true, group: "Copy" },
    ...
    { key: "secondaryCtaLabel", role: "secondary_action_label",label: "Secondary CTA label", type: { kind: "text", maxLength: 30 }, default: "Watch reel", priority: "button", aiPromptable: true, group: "CTAs" },
    { key: "secondaryCtaHref", role: "secondary_action_href",label: "Secondary CTA link", type: { kind: "link" }, default: "#reel", group: "CTAs" },
    { key: "videoMp4Url", role: "video_url",label: "Video (MP4) URL", type: { kind: "text", maxLength: 500 }, default: "", group: "Video", description: "Muted, looping, ~10-20s. H.264 MP4 recommended. Under 2MB for fast load." },
    { key: "videoWebmUrl", role: "video_url",label: "Video (WebM) URL", type: { kind: "text", maxLength: 500 }, default: "", group: "Video", description: "Optional WebM alternative — served to Chrome/Firefox for smaller file size." },
    { key: "posterImageUrl", role: "video_poster",label: "Poster image URL", type: { kind: "image", aspectRatio: "16:9", recommendedWidthPx: 1920 }, default: "https://ik.imagekit.io/9mrgsv2rp/ChatGPT%20Image%20Jul%203,%202026,%2009_12_44%20AM.png?updatedAt=1783044782133", group: "Video", description: "Shown before the video loads, as a fallback if the browser blocks autoplay, and as the standalone hero background when no video URL is set." },
    { key: "overlayOpacity", role: "opacity",label: "Overlay darkness", type: { kind: "number", min: 0.3, max: 0.85, step: 0.05 }, default: 0.55, group: "Layout" },
  ...
  defaultConfig: () => ({
    ...
    videoWebmUrl: "",
    posterImageUrl:
      "https://ik.imagekit.io/9mrgsv2rp/ChatGPT%20Image%20Jul%203,%202026,%2009_12_44%20AM.png?updatedAt=1783044782133",
    overlayOpacity: 0.55,
    ribbon1: "£5m insured",
