...
const registration: SectionRegistration<Config> = {
  ...
  editableFields: [
    ...
    { key: "brandDomain", label: "Brand domain / short URL", type: { kind: "text", maxLength: 40 }, default: "thenetworkers.app/mike", priority: "text", group: "QR" },
  ...
  defaultConfig: () => ({
    ...
    brandDomain: "thenetworkers.app/mike",
