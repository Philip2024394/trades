...
const registration: SectionRegistration<Config> = {
  ...
  editableFields: [
    ...
    { key: "eyebrow", role: "eyebrow",label: "Eyebrow", type: { kind: "text", maxLength: 60 }, default: "Feature", priority: "text", aiPromptable: true, group: "Copy" },
    { key: "heading", role: "headline",label: "Headline (serif italic)", type: { kind: "text", maxLength: 100 }, default: "Craft, without the bluster.", priority: "text", aiPromptable: true, group: "Copy" },
    { key: "subheading", role: "subhead",label: "Subheading", type: { kind: "text", maxLength: 200, multiline: true }, default: "Kitchens made in our workshop, fitted by the same hands that made them. No sub-contractors. No shortcuts.", priority: "text", aiPromptable: true, group: "Copy" },
    { key: "bodyLead", role: "body",label: "Body lead (with drop-cap)", type: { kind: "text", maxLength: 400, multiline: true }, default: "Every commission starts with a walk through the space. We measure, we listen, we sketch. Then we go away and design something that fits the room, the budget and the way you actually live. Every commission ends with a walk through the finished job — same hands, same care.", priority: "text", aiPromptable: true, group: "Copy" },
    { key: "primaryCtaLabel", role: "primary_action_label",label: "Primary CTA label", type: { kind: "text", maxLength: 30 }, default: "Commission a project", priority: "button", aiPromptable: true, group: "CTA" },
    { key: "primaryCtaHref", role: "primary_action_href",label: "Primary CTA link", type: { kind: "link" }, default: "#whatsapp", group: "CTA" },
    { key: "pullQuote", role: "quote",label: "Pull quote", type: { kind: "text", maxLength: 200, multiline: true }, default: "They didn't just build our kitchen — they understood our house.", priority: "text", aiPromptable: true, group: "Pull quote" },
    { key: "pullQuoteAuthor", role: "quote_author",label: "Pull quote author", type: { kind: "text", maxLength: 60 }, default: "Emma & James, York", priority: "text", group: "Pull quote" },
    { key: "heroImageUrl", role: "hero_media",label: "Hero image URL", type: { kind: "image", aspectRatio: "4:5", recommendedWidthPx: 1200 }, default: "", group: "Image" },
    { key: "surface", role: "surface_mode",label: "Surface", type: { kind: "select", options: [{ value: "cream", label: "Cream (premium)" }, { value: "onyx", label: "Onyx (moody)" }] }, default: "cream", group: "Layout" }
  ],
