...
function CursorSpotlightHero({
  ...
  const darkness = Math.max(0.4, Math.min(0.95, config.darknessLevel));
...
const registration: SectionRegistration<Config> = {
  ...
  editableFields: [
    { key: "eyebrow", label: "Eyebrow", type: { kind: "text", maxLength: 60 }, default: "Move your cursor to explore", priority: "text", aiPromptable: true, group: "Copy" },
    { key: "heading", label: "Headline", type: { kind: "text", maxLength: 100 }, default: "Trust in the dark.", priority: "text", aiPromptable: true, group: "Copy" },
    { key: "subheading", label: "Subheading", type: { kind: "text", maxLength: 240, multiline: true }, default: "24-hour emergency callouts, real engineers on the phone, and a written guarantee on every job. The kind of trade you can count on when the lights go out.", priority: "text", aiPromptable: true, group: "Copy" },
    ...
    { key: "chip2", label: "Chip 2", type: { kind: "text", maxLength: 40 }, default: "£5m insured", group: "Chips" },
    { key: "chip3", label: "Chip 3", type: { kind: "text", maxLength: 40 }, default: "12-month guarantee", group: "Chips" }
  ],
