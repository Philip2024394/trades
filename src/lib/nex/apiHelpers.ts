// Shared helpers between /api/nex/converse (sync) and
// /api/nex/converse/stream. Keeps auth + cap + image validation +
...
export type NexImage = { base64: string; media_type: "image/jpeg" | "image/png" | "image/webp" | "image/gif" };
...
export function validateImage(imageBase64: string, imageMediaType: string): NexImage | NextResponse | null {
  ...
  return {
    base64: imageBase64,
    media_type: imageMediaType as NexImage["media_type"]
  };
}
