// Streaming variant of the Nex agentic runtime. Same loop shape as
...
export type StreamEvent =
  ...
  | { type: "tool_end";    name: string; ok: boolean; ui?: NexUiCard }
  | { type: "done";        finalText: string; toolCalls: NexToolCall[]; uiCards: NexUiCard[]; usage: CompleteResult["usage"]; latencyMs: number; stoppedBy: "end_turn" | "max_steps" | "error" };
