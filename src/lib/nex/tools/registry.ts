// Nex tool registry. Static import list — one line per tool file.
...
import type { NexTool, NexSurface, NexTierGate } from "./types";
...
const TIER_ORDER: NexTierGate[] = ["free", "starter", "professional", "business", "works"];

function tierMeets(userTier: NexTierGate | null | undefined, required: NexTierGate | undefined): boolean {
...
export function toolsForSurface(surface: NexSurface, userTier?: NexTierGate | null): NexTool[] {
...
export function toolByName(name: string): NexTool | undefined {
