// Merchant tool. The default context builder gives Nex 7 days of
// merchant metrics. This tool lets Nex ask for a longer window +
...
import type { NexTool } from "./types";

export const getExtraAnalyticsTool: NexTool = {
