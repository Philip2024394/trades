...
// merchants so Nex can point the user at real profiles. Uses the
...
// avg rating, canonical URL. Nex's final answer names them + links.
...
export const findLocalTradeTool: NexTool = {
